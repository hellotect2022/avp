...
<title>소속 목록 | smartconvergence</title>
...
// 					"period":period
		...
		detail:function(companyId) {
			location.href = "/pc/company/companyDetailPage?companyId="+companyId;
		}
}
...
<div id="wrap">
  <!--본문-->       
	<div id="container"> 	
		...
		<div class="contents">
		<h2><span class="titel-text-sm">소속 관리 > </span>소속 목록</h2>
	  <!-- CONTENTS -->
