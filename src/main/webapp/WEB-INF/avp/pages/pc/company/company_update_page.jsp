...
$(document).ready(function(){
	...
	$("#updateBtn").click(function(){
		...
		FN.dialogShow();
		FN.dataSet($(this).attr("companyId"));
		FN.insert();
	});
		...
		insert : function ()
		{
			$.ajax( "/pc/company/companyUpdate",{
				...
				timeout : 20000, //제한시간 지정
			 	...
			 	error: function(result, status)
			 	{
			 		var  statusStr = "/pc/company/companyUpdate :"+status;
				 	// session time out
...
<div id="wrap">
 <!--본문-->       
	<div id="container"> 
		...
		<div class="contents">
			<h2><span class="titel-text-sm">소속관리 > 소속목록 > 소속상세 > </span> </span>소속수정</h2>
				...
				<form name="" method="" action="" >	
					...
					<table class="mytable2">
						...
						<tr>
							...
							<td> <input  id="companyName" type="text" name="targetcompanyNameName" value="${company.companyName}" class="inp_text" size="80" maxlength="45" placeholder="45자이내" ></td>                
						</tr> 
						<tr>
							<td class="tdbg01" scope="col">소속 설명</td>
							<td> <input  id="companyDesc" type="text" name="companyDesc"  value="${company.companyDesc}" class="inp_text"  size="80" maxlength="100"  placeholder="45자이내" ></td>                
						</tr> 
						<tr>
							<td class="tdbg01" scope="col">지점</td>
							<td> <input  id="companyBranch" type="text" name="companyBranch" value="${company.companyName}" class="inp_text"  size="80" maxlength="100"  placeholder="45자이내" ></td>                
						</tr> 
									 
						<tr>
							<td class="tdbg01" scope="col">주소</td>
							<td> <input  type="text" id="companyLocation" name="companyLocation" value="${company.companyLocation}" class="inp_text" size="80"  ></td>                
						</tr> 
			...
			<div class="paging">
				<button type="button" id="updateBtn" class="pagebtn2" companyId="${company.companyId}"><span class="btntxt">수정</span></button>&nbsp;&nbsp;&nbsp;<button type="button" id="cancelBtn" class="pagebtn2"><span class="btntxt">취소</span></button>
			</div>
    <!-- //CONTENT -->
		</div>
