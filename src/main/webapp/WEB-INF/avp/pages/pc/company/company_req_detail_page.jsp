...
<title>소속등록신청 상세 | smartconvergence</title>
...
$(document).ready(function(){
	...
	$("#updateBtn").click(function(){
		if(!confirm("소속을 생성하시겠습니까?"))
		{
			return;	
		}	
		FN.dialogShow();
		FN.companyCreate($(this).attr("companyId"));
	});
...
var FN = 
{
		...
		companyCreate : function(companyId)
		{
			$.ajax( "/pc/company/companyReqUpdate",{
			 	type : "POST", //"POST", "GET"
				dataType :  "json", //전송받을 데이터의 타입
				data : JSON.stringify({
					"companyId":companyId,
				...
				timeout : 20000, //제한시간 지정
			 	...
			 	success: function(data){
			 		...
			 		alert("정상적으로 생성되었습니다.")
					location.href = "/pc/company/companyReqListPage";
...
<div id="wrap">
	...
	<div id="container"> 
		...
		<div class="contents">
			<h2><span class="titel-text-sm">소속 관리 > 소속등록신청 목록 > </span>소속등록신청 상세</h2>

			<fieldset>	
				<form name="" method="" action="" >	
					<legend>소속등록신청 상세</legend>	
					<table class="mytable2">
						<caption>소속등록신청 상세</caption>
						<colgroup>
							<col width="20%"/>
							<col width="80%"/>
						</colgroup>
						...
						<tr>
							...
							<td class="tdbg02" id="nickName">${company.nickName} </td>                
						</tr> 
						<tr>
							<td class="tdbg01" scope="col">신청일</td>
							 <td class="tdbg02" id="createDate">${company.companyCreateDate}</td> 
						</tr>
					</table>
				</form>
			</fieldset>
			<div class="paging">
				<button type="button" id="updateBtn" class="pagebtn2" companyId="${company.companyId}"><span class="btntxt">승인</span></button>&nbsp;&nbsp;&nbsp;
