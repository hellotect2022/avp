...
<title>상품 수정 | smartconvergence</title>
...
<div id="wrap">
   	...
   	<div id="container"> 
		...
		<div class="contents">
			<h2><span class="titel-text-sm">상품 관리 > 상품 목록 > 상품 상세 > </span>상품 수정</h2>

			<fieldset>	
				<form id="frm" action="/pc/product/productUpdate" method="post">	
					<input type="hidden" name="itemId" value="${product.itemId}"/>
					<input type="hidden" id="branchId" name="branchId" value="${product.branchId}"/>
					<input type="hidden" id="barcodeType" name="barcodeType" value="${product.barcodeType}"/>
					...
					<table class="mytable2">
						...
						<tr>
							...
							<td class="tdbg02">
								<input type="text" id="itemName" name="itemName" maxlength="180" style="width:700px;" value="${product.itemName}"/>
							</td>  
						</tr>
						<tr>
							<td class="tdbg01" scope="col">바코드</td>
							<td class="tdbg02">
								<input type="text" id="barcode" name="barcode" maxlength="180" style="width:700px;" value="${product.barcode}"/>
							</td>  
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tdbg02">
								ZONE
								<input type="text" id="zone" name="zone" maxlength="180" style="width:700px;" value="${product.zone}"/>
							</td>
						</tr>
						<tr>
							<td class="tdbg02">
								LOCAL
								<input type="text" id="local" name="local" maxlength="180" style="width:700px;" value="${product.local}"/>
							</td>
						</tr>
						<tr>
							<td class="tdbg02">
								LOCATION
								<input type="text" id="location" name="location" maxlength="180" style="width:700px;" value="${product.location}"/>
							</td>
						</tr>
					</table>
				</form>
			...
			<div class="paging">
				<button type="button" id="updateBtn" class="pagebtn2" style="display: none;"><span class="btntxt">저장</span></button>
				&nbsp;&nbsp;&nbsp;
