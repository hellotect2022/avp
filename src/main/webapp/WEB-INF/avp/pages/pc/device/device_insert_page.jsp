...
<title>디바이스 등록 | smartconvergence</title>
...
<body>
 <div id="wrap">
	...
	<div id="container"> 
		<div class="contents">
			<h2><span class="titel-text-sm">디바이스 관리 > </span>디바이스 등록</h2>

			<fieldset>	
				<form id="frm" name="" method="post" action="/pc/device/deviceInsert">
					<input type="hidden" id="branchId" name="branchId"/>
					<legend>디바이스 등록</legend>
					<table id="deviceInsertTable" class="mytable2">
						<caption>디바이스 등록</caption>
						<colgroup>
							<col width="20%"/>
							<col width="80%"/>
						</colgroup>
						...
						<tr>
							...
							<td class="tdbg02">
								<input type="text" id="deviceName" name="deviceName" required="required" maxlength="20" style="width:510px;"/>
							</td>
						</tr>
						<tr>
							<td class="tdbg01" scope="col">일련번호</td>
							<td class="tdbg02">
								<input type="text" id="serial" name="serial" required="required" maxlength="20" style="width:510px;"/>
							</td>
						</tr>
					</table>
				</form>
